...
.getStandardCategories <- function() {
  dplyr::tibble(categoryStandard = c("conceptSet",
    ...
    dplyr::mutate(categoryUrl = dplyr::case_when(categoryStandard == "conceptSet" ~ "conceptset", 
                                                 ...
                                                 categoryStandard == "estimation" ~ "estimation", categoryStandard == "prediction" ~ "prediction", TRUE ~ "")) %>% 
    dplyr::mutate(categoryUrlGetExpression = dplyr::case_when(categoryStandard == "conceptSet" ~ "expression", 
                                                              categoryStandard == "characterization" ~ "export", categoryStandard == "pathway" ~ "export", TRUE ~ "")) %>% 
    ...
    dplyr::mutate(categoryUrlCancel = dplyr::case_when(categoryStandard == "cohort" ~ "cancel", 
                                                       ...
                                                       categoryStandard == "pathway" ~ "generation", 
                                                       categoryStandard == "incidenceRate" ~ "execute", TRUE ~ "")) %>% 
    dplyr::mutate(categoryUrlPut = dplyr::case_when(categoryStandard == "conceptSet" ~ "items", TRUE ~ "")) %>% 
    dplyr::mutate(categoryUrlPostExpression = dplyr::case_when(categoryStandard == "conceptSet" ~ "items", 
                                                               ...
                                                               categoryStandard == "incidenceRate" ~ "", TRUE ~ "")) %>% 
    return()
}
