...
postConceptSetDefinition <- function(name, conceptSetDefinition, baseUrl){
  baseUrl <- gsub("/$", "", baseUrl)
  result <- postDefinition(name = name, baseUrl = baseUrl, category = 'conceptSet', definition = conceptSetDefinition)
  return(result)
}
...
postCohortDefinition <- function(name, cohortDefinition, baseUrl){
  baseUrl <- gsub("/$", "", baseUrl)
  result <- postDefinition(name = name, baseUrl = baseUrl, category = 'cohort', definition = cohortDefinition)
  return(result)
}
...
postIncidenceRateDefinition <- function(name, incidenceRateDefinition, baseUrl){
  baseUrl <- gsub("/$", "", baseUrl)
  result <- postDefinition(name = name, baseUrl = baseUrl, category = 'incidenceRate', definition = incidenceRateDefinition)
  return(result)
}
...
postEstimationDefinition <- function(name, estimationDefinition, baseUrl){
  baseUrl <- gsub("/$", "", baseUrl)
  result <- postDefinition(name = name, baseUrl = baseUrl, category = 'estimation', definition = estimationDefinition)
  return(result)
}
...
postPredictionDefinition <- function(name, predictionDefinition, baseUrl){
  baseUrl <- gsub("/$", "", baseUrl)
  result <- postDefinition(name = name, baseUrl = baseUrl, category = 'prediction', definition = predictionDefinition)
  return(result)
}
...
postCharacterizationDefinition <- function(name, characterizationDefinition, baseUrl){
  baseUrl <- gsub("/$", "", baseUrl)
  result <- postDefinition(name = name, baseUrl = baseUrl, category = 'characterization', definition = characterizationDefinition)
  return(result)
}
