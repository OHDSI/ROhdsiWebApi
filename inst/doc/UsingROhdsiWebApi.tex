...
\CommentTok{#>   sourceId sourceName      sourceKey  sourceDialect cdmDatabaseSche~ vocabDatabaseSch~ resultsDatabaseSc~}
\CommentTok{#>      <int> <chr>           <chr>      <chr>         <chr>            <chr>             <chr>             }
\CommentTok{#> 1        4 Common Evidenc~ CEM        postgresql    <NA>             unrestricted      <NA>              }
...
\CommentTok{#> 2 1775231 [C2Q]2020-09-09~ ""           2015-03-06 20:49:00 ""            <NA>        NA                 }
\CommentTok{#> 3 1775232 Coronary Artery~ ""           2015-03-06 20:49:00 ""            <NA>        NA                 }
\CommentTok{#> 4 1775233 [C2Q]diabetes 2~ ""           2015-03-06 20:49:00 ""            <NA>        NA                 }
\CommentTok{#> 5 1775234 [C2Q]diabetes 2~ ""           2015-03-06 20:49:00 ""            <NA>        NA                 }
\CommentTok{#> 6 1775236 CUIMC Med Stude~ ""           2015-03-06 20:49:00 ""            <NA>        NA}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1   392 "VC Index CUMC"              2020-08-24 09:47:21 2020-08-24 09:54:28 ComparativeCoh~  <NA>       }
\CommentTok{#> 2   393 "metforminP4_intent_to_trea~ 2020-08-26 21:14:41 2020-08-26 21:31:11 ComparativeCoh~  <NA>       }
\CommentTok{#> 3   394 "EXAMPLE : New Population L~ 2020-08-27 09:46:44 2020-08-27 10:36:56 ComparativeCoh~  <NA>       }
\CommentTok{#> 4   395 " [NA] 0828 AKI - procedure" 2020-08-27 22:21:09 NA                  ComparativeCoh~  <NA>       }
\CommentTok{#> 5   396 "jk_new"                     2020-08-28 02:26:52 NA                  ComparativeCoh~ "drug - ost~}
\CommentTok{#> 6   397 "[1105] DOAC - subgroups (C~ 2020-09-02 12:45:18 2020-09-02 12:45:44 ComparativeCoh~  <NA>}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1 ""        ""         2020-09-10 01:41:06 2020-09-10 01:41:06 1865443 [ROhdsiWebApi Vignette] Rheumatoi~}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{\}}
\CommentTok{#> Successfully deleted conceptSet definition id 1865443. Request status code: Success: (204) No Content}
\CommentTok{#> NULL}
\end{Highlighting}
\end{Shaded}
...
#> 1 NA        NA         2020-09-10 01:42:37 2020-09-10 01:42:37 1865444 [ROhdsiWebApi Vignette] Rheumatoi~
\end{verbatim}

The id of the newly posted concept-set definition is 1865444. We can now
...
\CommentTok{#>   `Is Excluded` `Include Descen~ `Include Mapped` `Concept Id` `Concept Name` `Standard Conce~}
\CommentTok{#>   <lgl>         <lgl>            <lgl>                   <int> <chr>          <chr>           }
\CommentTok{#> 1 TRUE          FALSE            FALSE                   81097 Felty's syndr~ S               }
\CommentTok{#> 2 FALSE         TRUE             FALSE                   80809 Rheumatoid ar~ S               }
\CommentTok{#> 3 FALSE         TRUE             FALSE                 4035611 Seropositive ~ S               }
\CommentTok{#> # ... with 7 more variables: `Standard Concept Caption` <chr>, `Invalid Reason` <chr>, `Invalid Reason}
\CommentTok{#> #   Caption` <chr>, `Concept Code` <chr>, `Domain Id` <chr>, `Vocabulary Id` <chr>, `Concept Class}
\CommentTok{#> #   Id` <chr>}
\end{Highlighting}
\end{Shaded}
