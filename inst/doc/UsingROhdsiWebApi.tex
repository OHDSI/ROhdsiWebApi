...
<<<<<<< HEAD
\CommentTok{#>   sourceId sourceName            sourceKey  sourceDialect cdmDatabaseSchema vocabDatabaseSchema resultsDatabaseSche~}
...
\CommentTok{#> 1 1775230 afib ny                     ""           2015-03-06 20:49:00 ""            <NA>        NA                 }
\CommentTok{#> 2 1775231 [C2Q]2020-09-09_13_35_19_8~ ""           2015-03-06 20:49:00 ""            <NA>        NA                 }
\CommentTok{#> 3 1775232 Coronary Artery Disease     ""           2015-03-06 20:49:00 ""            <NA>        NA                 }
\CommentTok{#> 4 1775233 [C2Q]diabetes 2020-09-09_1~ ""           2015-03-06 20:49:00 ""            <NA>        NA                 }
\CommentTok{#> 5 1775234 [C2Q]diabetes 2020-09-09_1~ ""           2015-03-06 20:49:00 ""            <NA>        NA                 }
\CommentTok{#> 6 1775236 CUIMC Med Student Demo HCQ  ""           2015-03-06 20:49:00 ""            <NA>        NA}
=======
\CommentTok{#>        Id Name                                                             `Created By` `Created Date`      `Modified By` Description `Modified Date`    }
\CommentTok{#>     <int> <chr>                                                            <chr>        <dttm>              <chr>         <chr>       <dttm>             }
\CommentTok{#> 1 1775202 "[APAC HTN] Cohort #3:  ACEi/ARB (1st Drug) + Diuretic (2nd Dru~ ""           2015-03-06 20:49:00 ""            <NA>        NA                 }
\CommentTok{#> 2 1775203 "[APAC HTN] Cohort #5: ACEi/ARB (1st Drug) + B-blocker (2nd Dru~ ""           2015-03-06 20:49:00 ""            <NA>        NA                 }
\CommentTok{#> 3 1775204 "[APAC HTN] ACEi/ARB use after hypertension diagnosis "          ""           2015-03-06 20:49:00 ""            <NA>        NA                 }
\CommentTok{#> 4 1775205 "[APAC HTN] Diuretic use after hypertension diagnosis "          ""           2015-03-06 20:49:00 ""            <NA>        NA                 }
\CommentTok{#> 5 1775206 "[APAC HTN] CCB use after hypertension diagnosis "               ""           2015-03-06 20:49:00 ""            <NA>        NA                 }
\CommentTok{#> 6 1775207 "[APAC HTN] Beta-blocker use after hypertension diagnosis "      ""           2015-03-06 20:49:00 ""            <NA>        NA}
>>>>>>> upstream/develop
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1   392 "VC Index CUMC"                     2020-08-24 09:47:21 2020-08-24 09:54:28 ComparativeCohort~  <NA>        }
\CommentTok{#> 2   393 "metforminP4_intent_to_treat"       2020-08-26 21:14:41 2020-08-26 21:31:11 ComparativeCohort~  <NA>        }
\CommentTok{#> 3   394 "EXAMPLE : New Population Level Es~ 2020-08-27 09:46:44 2020-08-27 10:36:56 ComparativeCohort~  <NA>        }
\CommentTok{#> 4   395 " [NA] 0828 AKI - procedure"        2020-08-27 22:21:09 NA                  ComparativeCohort~  <NA>        }
\CommentTok{#> 5   396 "jk_new"                            2020-08-28 02:26:52 NA                  ComparativeCohort~ "drug - oste~}
\CommentTok{#> 6   397 "[1105] DOAC - subgroups (COT)"     2020-09-02 12:45:18 2020-09-02 12:45:44 ComparativeCohort~  <NA>}
=======
\CommentTok{#>      Id Name                                                 `Created Date`      `Modified Date`     Type                      Description    }
\CommentTok{#>   <int> <chr>                                                <dttm>              <dttm>              <chr>                     <chr>          }
\CommentTok{#> 1   392 "VC Index CUMC"                                      2020-08-24 09:47:21 2020-08-24 09:54:28 ComparativeCohortAnalysis  <NA>          }
\CommentTok{#> 2   393 "metforminP4_intent_to_treat"                        2020-08-26 21:14:41 2020-08-26 21:31:11 ComparativeCohortAnalysis  <NA>          }
\CommentTok{#> 3   394 "EXAMPLE : New Population Level Estimation Analysis" 2020-08-27 09:46:44 2020-08-27 10:36:56 ComparativeCohortAnalysis  <NA>          }
\CommentTok{#> 4   395 " [NA] 0828 AKI - procedure"                         2020-08-27 22:21:09 NA                  ComparativeCohortAnalysis  <NA>          }
\CommentTok{#> 5   396 "jk_new"                                             2020-08-28 02:26:52 NA                  ComparativeCohortAnalysis "drug - osteo "}
\CommentTok{#> 6   397 "[1105] DOAC - subgroups (COT)"                      2020-09-02 12:45:18 2020-09-02 12:45:44 ComparativeCohortAnalysis  <NA>}
>>>>>>> upstream/develop
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> 1 ""        ""         2020-09-10 07:44:46 2020-09-10 07:44:46 1865448 [ROhdsiWebApi Vignette] Rheumatoid Arthritis~}
=======
\CommentTok{#>   createdBy modifiedBy createdDate         modifiedDate             id name                                                    }
\CommentTok{#>   <chr>     <chr>      <dttm>              <dttm>                <int> <chr>                                                   }
...
\NormalTok{\}}
<<<<<<< HEAD
\CommentTok{#> Successfully deleted conceptSet definition id 1865448. Request status code: Success: (204) No Content}
=======
\CommentTok{#> Successfully deleted conceptSet definition id 1865261. Request status code: Success: (204) No Content}
>>>>>>> upstream/develop
\CommentTok{#> NULL}
\end{Highlighting}
\end{Shaded}
...
#> 1 NA        NA         2020-09-10 07:50:07 2020-09-10 07:50:07 1865449 [ROhdsiWebApi Vignette] Rheumatoid Arthritis~
\end{verbatim}

The id of the newly posted concept-set definition is 1865449. We can now
=======
#>   createdBy modifiedBy createdDate         modifiedDate             id name                                                    
#>   <lgl>     <lgl>      <dttm>              <dttm>                <int> <chr>                                                   
#> 1 NA        NA         2020-09-07 09:05:00 2020-09-07 09:05:00 1865396 [ROhdsiWebApi Vignette] Rheumatoid Arthritis concept set
\end{verbatim}

The id of the newly posted concept-set definition is 1865396. We can now
>>>>>>> upstream/develop
...
<<<<<<< HEAD
\CommentTok{#>   `Is Excluded` `Include Descen~ `Include Mapped` `Concept Id` `Concept Name` `Standard Conce~ `Standard Conce~}
\CommentTok{#>   <lgl>         <lgl>            <lgl>                   <int> <chr>          <chr>            <chr>           }
\CommentTok{#> 1 TRUE          FALSE            FALSE                   81097 Felty's syndr~ S                Standard        }
\CommentTok{#> 2 FALSE         TRUE             FALSE                   80809 Rheumatoid ar~ S                Standard        }
\CommentTok{#> 3 FALSE         TRUE             FALSE                 4035611 Seropositive ~ S                Standard        }
\CommentTok{#> # ... with 6 more variables: `Invalid Reason` <chr>, `Invalid Reason Caption` <chr>, `Concept Code` <chr>, `Domain}
\CommentTok{#> #   Id` <chr>, `Vocabulary Id` <chr>, `Concept Class Id` <chr>}
=======
\CommentTok{#>   `Is Excluded` `Include Descen~ `Include Mapped` `Concept Id` `Concept Name` `Standard Conce~ `Standard Conce~ `Invalid Reason` `Invalid Reason~}
\CommentTok{#>   <lgl>         <lgl>            <lgl>                   <int> <chr>          <chr>            <chr>            <chr>            <chr>           }
\CommentTok{#> 1 TRUE          FALSE            FALSE                   81097 Felty's syndr~ S                Standard         V                Valid           }
\CommentTok{#> 2 FALSE         TRUE             FALSE                   80809 Rheumatoid ar~ S                Standard         V                Valid           }
\CommentTok{#> 3 FALSE         TRUE             FALSE                 4035611 Seropositive ~ S                Standard         V                Valid           }
\CommentTok{#> # ... with 4 more variables: `Concept Code` <chr>, `Domain Id` <chr>, `Vocabulary Id` <chr>, `Concept Class Id` <chr>}
>>>>>>> upstream/develop
\end{Highlighting}
\end{Shaded}
