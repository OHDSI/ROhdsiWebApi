...
\NormalTok{\}}
\CommentTok{#> Successfully deleted conceptSet definition id 1865449. Request status code: Success: (204) No Content}
\CommentTok{#> NULL}
\end{Highlighting}
\end{Shaded}
...
#> 1 NA        NA         2020-09-10 08:09:43 2020-09-10 08:09:43 1865450 [ROhdsiWebApi Vignette] Rheumatoid Arthritis~
\end{verbatim}

The id of the newly posted concept-set definition is 1865450. We can now
