...
\NormalTok{ROhdsiWebApi}\OperatorTok{::}\KeywordTok{getDefinitionsMetadata}\NormalTok{(}\DataTypeTok{baseUrl =}\NormalTok{ baseUrl, }
                                     \DataTypeTok{category =} \StringTok{\textquotesingle{}cohort\textquotesingle{}}\NormalTok{) }\OperatorTok{\%>\%}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(.data}\OperatorTok{$}\NormalTok{id) }\OperatorTok{\%>\%}
\StringTok{  }\KeywordTok{rename\_all}\NormalTok{(}\DataTypeTok{.funs =}\NormalTok{ SqlRender}\OperatorTok{::}\NormalTok{camelCaseToTitleCase) }\OperatorTok{\%>\%}
\StringTok{  }\KeywordTok{tail}\NormalTok{() }
\CommentTok{\#> \# A tibble: 6 x 7}
\CommentTok{\#>        Id Name                                                      \textasciigrave{}Created By\textasciigrave{} \textasciigrave{}Created Date\textasciigrave{}      \textasciigrave{}Modified By\textasciigrave{} Description \textasciigrave{}Modified Date\textasciigrave{}    }
\CommentTok{\#>     <int> <chr>                                                     <chr>        <dttm>              <chr>         <chr>       <dttm>             }
\CommentTok{\#> 1 1774574 " SH\_target\_hypoparathyroidism\_exclude\_thyroidectomy (1)" ""           2015{-}03{-}06 20:49:00 ""            <NA>        NA                 }
\CommentTok{\#> 2 1774575 "New Cohort / Test 2"                                     ""           2015{-}03{-}06 20:49:00 ""            <NA>        NA                 }
\CommentTok{\#> 3 1774576 "AML patients from IPOP"                                  ""           2015{-}03{-}06 20:49:00 ""            <NA>        NA                 }
\CommentTok{\#> 4 1774577 "[TS] LEGEND Depression IPCI"                             ""           2015{-}03{-}06 20:49:00 ""            <NA>        NA                 }
\CommentTok{\#> 5 1774578 "diabetes (5)"                                            ""           2015{-}03{-}06 20:49:00 ""            <NA>        NA                 }
\CommentTok{\#> 6 1774579 "mineral\_metabolism\_target"                               ""           2015{-}03{-}06 20:49:00 ""            <NA>        NA}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{rename\_all}\NormalTok{(}\DataTypeTok{.funs =}\NormalTok{ SqlRender}\OperatorTok{::}\NormalTok{camelCaseToTitleCase) }\OperatorTok{\%>\%}\StringTok{ }
\StringTok{  }\KeywordTok{tail}\NormalTok{() }
\CommentTok{\#> \# A tibble: 6 x 7}
\CommentTok{\#>        Id Name                                                      \textasciigrave{}Created By\textasciigrave{} \textasciigrave{}Created Date\textasciigrave{}      \textasciigrave{}Modified By\textasciigrave{} Description \textasciigrave{}Modified Date\textasciigrave{}    }
\CommentTok{\#>     <int> <chr>                                                     <chr>        <dttm>              <chr>         <chr>       <dttm>             }
...
\NormalTok{ROhdsiWebApi}\OperatorTok{::}\KeywordTok{getDefinitionsMetadata}\NormalTok{(}\DataTypeTok{baseUrl =}\NormalTok{ baseUrl, }
                                     \DataTypeTok{category =} \StringTok{\textquotesingle{}estimation\textquotesingle{}}\NormalTok{) }\OperatorTok{\%>\%}\StringTok{ }
\StringTok{  }\KeywordTok{arrange}\NormalTok{(.data}\OperatorTok{$}\NormalTok{id) }\OperatorTok{\%>\%}\StringTok{ }
\StringTok{  }\KeywordTok{rename\_all}\NormalTok{(}\DataTypeTok{.funs =}\NormalTok{ SqlRender}\OperatorTok{::}\NormalTok{camelCaseToTitleCase) }\OperatorTok{\%>\%}\StringTok{ }
\StringTok{  }\KeywordTok{tail}\NormalTok{()}
\CommentTok{\#> \# A tibble: 6 x 6}
\CommentTok{\#>      Id Name                          \textasciigrave{}Created Date\textasciigrave{}      \textasciigrave{}Modified Date\textasciigrave{}     Type          Description                                             }
\CommentTok{\#>   <int> <chr>                         <dttm>              <dttm>              <chr>         <chr>                                                   }
\CommentTok{\#> 1   361 "COPY OF: YBY\_ACEi versus TH\textasciitilde{} 2020{-}06{-}08 02:17:38 2020{-}06{-}08 06:19:50 ComparativeC\textasciitilde{} YBY\_Comparing ACE inhibitors to thiazides and thiazide{-}\textasciitilde{}}
\CommentTok{\#> 2   362 "PLE {-} DOAC"                  2020{-}06{-}09 14:57:28 2020{-}06{-}09 15:08:51 ComparativeC\textasciitilde{} <NA>                                                    }
\CommentTok{\#> 3   363 "New Population Level{-}test"   2020{-}06{-}16 03:15:00 NA                  ComparativeC\textasciitilde{} <NA>                                                    }
\CommentTok{\#> 4   364 "[ymp] Metformin vs Sulfonyl\textasciitilde{} 2020{-}06{-}18 01:37:44 NA                  ComparativeC\textasciitilde{} <NA>                                                    }
\CommentTok{\#> 5   365 "[YM] PLE Hypertension"       2020{-}06{-}29 11:01:10 2020{-}06{-}29 15:58:25 ComparativeC\textasciitilde{} <NA>                                                    }
\CommentTok{\#> 6   366 "SH\_mineral\_dementia"         2020{-}06{-}30 03:18:33 2020{-}06{-}30 03:25:39 ComparativeC\textasciitilde{} <NA>}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{\}}
\CommentTok{\#> Successfully deleted conceptSet definition id 1864626. Request status code: Success: (204) No Content}
\CommentTok{\#> NULL}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#>   \textasciigrave{}Is Excluded\textasciigrave{} \textasciigrave{}Include Descen\textasciitilde{} \textasciigrave{}Include Mapped\textasciigrave{} \textasciigrave{}Concept Id\textasciigrave{} \textasciigrave{}Concept Name\textasciigrave{} \textasciigrave{}Standard Conce\textasciitilde{} \textasciigrave{}Standard Conce\textasciitilde{} \textasciigrave{}Invalid Reason\textasciigrave{} \textasciigrave{}Invalid Reason\textasciitilde{}}
\CommentTok{\#>   <lgl>         <lgl>            <lgl>                   <int> <chr>          <chr>            <chr>            <chr>            <chr>           }
\CommentTok{\#> 1 TRUE          FALSE            FALSE                   81097 Felty\textquotesingle{}s syndr\textasciitilde{} S                Standard         V                Valid           }
\CommentTok{\#> 2 FALSE         TRUE             FALSE                   80809 Rheumatoid ar\textasciitilde{} S                Standard         V                Valid           }
\CommentTok{\#> 3 FALSE         TRUE             FALSE                 4035611 Seropositive \textasciitilde{} S                Standard         V                Valid           }
\CommentTok{\#> \# ... with 4 more variables: \textasciigrave{}Concept Code\textasciigrave{} <chr>, \textasciigrave{}Domain Id\textasciigrave{} <chr>, \textasciigrave{}Vocabulary Id\textasciigrave{} <chr>, \textasciigrave{}Concept Class Id\textasciigrave{} <chr>}
\end{Highlighting}
\end{Shaded}
